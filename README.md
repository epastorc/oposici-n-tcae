...
El repositorio incluye un banco de `3.376` preguntas extraídas de `42` fuentes y un
...
consultada y la fecha de revisión. Actualmente hay `3.146` preguntas con respuesta
